<?php
    ...
    $ruteador->addRoute('productos/imagen/:ID', 'POST', 'controllerApi', 'addImagen');
    $ruteador->addRoute('productos/:ID', 'PUT', 'controllerApi', 'update');
    $ruteador->addRoute('productos/:ID', 'DELETE', 'controllerApi', 'delete');
    $ruteador->addRoute('productos/:ID/imagen/:IMG', 'DELETE', 'controllerApi', 'deleteImagen');
    $ruteador->addRoute('productos/:ID/imagen', 'POST', 'controllerApi', 'addImagen');
